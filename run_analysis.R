## run_analysis.R
# The run_analysis.R script file is used to generate a tiday data set with the average of each variable
# for each activity and each subject.  The needed data sets are created by merging training and the
# test sets generated by UCI's Human Activity Recognition Using Smartphones project.
